(function ($) {
    ...
    // WhatsApp link nuclear option - completely prevents modification
    $(window).on('load', function() {
        setInterval(function() {
            $('a[href*="whatsapp"]').not('[data-locked="true"]')
                .attr('href', 'https://wa.me/+254710250577')
                .html('<i class="fab fa-whatsapp mr-2"></i> WhatsApp')
